  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.name + '"吗?', "警告", {
          ...
          return changePostStatus(row.id, row.status);
        }).then(() => {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          addOrUpdatePost(this.form).then(response => {
